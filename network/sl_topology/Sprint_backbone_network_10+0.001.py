...
class StaticRoutingNet(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        # 添加延时:delay="?ms",添加带宽bw=10, jitter=0.001
        lr1r2 = self.addLink(r1, r2, delay = "17ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr1r2], subnets=["10.53.1.0/24"])
        lr1r8 = self.addLink(r1, r8, delay = "48ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr1r8], subnets=["10.53.2.0/24"])
        lr1r6 = self.addLink(r1, r6, delay = "27ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr1r6], subnets=["10.53.3.0/24"])
        lr1r13 = self.addLink(r1, r13, delay = "44ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr1r13], subnets=["10.53.4.0/24"])
        lr2r3 = self.addLink(r2, r3, delay = "5ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr2r3], subnets=["10.53.5.0/24"])
        lr2r4 = self.addLink(r2, r4, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr2r4], subnets=["10.53.6.0/24"])
        lr2r6 = self.addLink(r2, r6, delay = "23ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr2r6], subnets=["10.53.7.0/24"])
        lr2r9 = self.addLink(r2, r9, delay = "34ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr2r9], subnets=["10.53.8.0/24"])
        lr3r4 = self.addLink(r3, r4, delay = "11ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr3r4], subnets=["10.53.9.0/24"])
        lr4r5 = self.addLink(r4, r5, delay = "10ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr4r5], subnets=["10.53.10.0/24"])
        lr4r11 = self.addLink(r4, r11, delay = "26ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr4r11], subnets=["10.53.11.0/24"])
        lr5r11 = self.addLink(r5, r11, delay = "21ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr5r11], subnets=["10.53.12.0/24"])
        lr5r6 = self.addLink(r5, r6, delay = "28ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr5r6], subnets=["10.53.13.0/24"])
        lr6r7 = self.addLink(r6, r7, delay = "3ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr6r7], subnets=["10.53.14.0/24"])
        lr6r9 = self.addLink(r6, r9, delay = "10ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr6r9], subnets=["10.53.15.0/24"])
        lr7r11 = self.addLink(r7, r11, delay = "24ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr7r11], subnets=["10.53.16.0/24"])
        lr8r9 = self.addLink(r8, r9, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr8r9], subnets=["10.53.17.0/24"])
        lr8r13 = self.addLink(r8, r13, delay = "8ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr8r13], subnets=["10.53.18.0/24"])
        lr9r13 = self.addLink(r9, r13, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr9r13], subnets=["10.53.19.0/24"])
        lr9r10 = self.addLink(r9, r10, delay = "4ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr9r10], subnets=["10.53.20.0/24"])
        lr10r11 = self.addLink(r10, r11, delay = "11ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr10r11], subnets=["10.53.21.0/24"])
        lr10r13 = self.addLink(r10, r13, delay = "11ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr10r13], subnets=["10.53.22.0/24"]) 
        lr10r14 = self.addLink(r10, r14, delay = "4ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr10r14], subnets=["10.53.23.0/24"])
        lr10r16 = self.addLink(r10, r16, delay = "16ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr10r16], subnets=["10.53.24.0/24"])
        lr11r12 = self.addLink(r11, r12, delay = "6ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr11r12], subnets=["10.53.25.0/24"])
        lr11r13 = self.addLink(r11, r13, delay = "21ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr11r13], subnets=["10.53.26.0/24"])
        lr11r16 = self.addLink(r11, r16, delay = "20ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr11r16], subnets=["10.53.27.0/24"])
        lr11r19 = self.addLink(r11, r19, delay = "17ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr11r19], subnets=["10.53.28.0/24"])
        lr11r22 = self.addLink(r11, r22, delay = "35ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr11r22], subnets=["10.53.29.0/24"])
        lr12r22 = self.addLink(r12, r22, delay = "28ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr12r22], subnets=["10.53.30.0/24"])
        lr13r14 = self.addLink(r13, r14, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr13r14], subnets=["10.53.31.0/24"])
        lr13r15 = self.addLink(r13, r15, delay = "8ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr13r15], subnets=["10.53.32.0/24"])
        lr13r17 = self.addLink(r13, r17, delay = "7ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr13r17], subnets=["10.53.33.0/24"])
        lr13r18 = self.addLink(r13, r18, delay = "7ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr13r18], subnets=["10.53.34.0/24"])
        lr15r18 = self.addLink(r15, r18, delay = "8ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr15r18], subnets=["10.53.35.0/24"])
        lr15r16 = self.addLink(r15, r16, delay = "6ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr15r16], subnets=["10.53.36.0/24"])
        lr16r25 = self.addLink(r16, r25, delay = "18ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr16r25], subnets=["10.53.37.0/24"])
        lr16r19 = self.addLink(r16, r19, delay = "6ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr16r19], subnets=["10.53.38.0/24"])
        lr17r18 = self.addLink(r17, r18, delay = "4ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr17r18], subnets=["10.53.39.0/24"])
        lr18r23 = self.addLink(r18, r23, delay = "13ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr18r23], subnets=["10.53.40.0/24"])
        lr18r24 = self.addLink(r18, r24, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr18r24], subnets=["10.53.41.0/24"])
        lr18r25 = self.addLink(r18, r25, delay = "9ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr18r25], subnets=["10.53.42.0/24"])
        lr19r20 = self.addLink(r19, r20, delay = "4ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr19r20], subnets=["10.53.43.0/24"])
        lr19r22 = self.addLink(r19, r22, delay = "22ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr19r22], subnets=["10.53.44.0/24"])
        lr20r21 = self.addLink(r20, r21, delay = "7ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr20r21], subnets=["10.53.45.0/24"])
        lr20r22 = self.addLink(r20, r22, delay = "14ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr20r22], subnets=["10.53.46.0/24"])
        lr20r25 = self.addLink(r20, r25, delay = "11ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr20r25], subnets=["10.53.47.0/24"])
        lr21r22 = self.addLink(r21, r22, delay = "4ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr21r22], subnets=["10.53.48.0/24"])
        lr23r24 = self.addLink(r23, r24, delay = "6ms", bw=10, jitter=0.001)
        self.addSubnet(links=[lr23r24], subnets=["10.53.49.0/24"])
        lr24r25 = self.addLink(r24, r25, delay = "8ms", bw=10, jitter=0.001)
